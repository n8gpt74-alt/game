...
QUEST_DEFINITIONS: dict[str, QuestDefinition] = {
    ...
    "math_training": QuestDefinition(
        quest_key="math_training",
        title="Математик",
        description="Решайте математические мини-игры",
        steps=[
            QuestStepDefinition(
                metric="minigame:math",
                title="Сыграть 1 математическую игру",
                description="Пройдите любую математическую мини-игру",
                target=1,
                reward_coins=25,
                reward_xp=10,
            ),
            QuestStepDefinition(
                metric="minigame:math",
                title="Сыграть 3 математические игры",
                description="Продолжайте тренировать счёт",
                target=3,
                reward_coins=45,
                reward_xp=18,
            ),
            QuestStepDefinition(
                metric="minigame:math",
                title="Сыграть 5 математических игр",
                description="Закрепите математические навыки",
                target=5,
                reward_coins=70,
                reward_xp=25,
            ),
    ...
    "letters_training": QuestDefinition(
        quest_key="letters_training",
        title="Азбука",
        description="Тренируйтесь в играх по буквам",
        steps=[
            QuestStepDefinition(
                metric="minigame:letters",
                title="Сыграть 1 буквенную игру",
                description="Пройдите любую буквенную мини-игру",
                target=1,
                reward_coins=25,
                reward_xp=10,
            ),
            QuestStepDefinition(
                metric="minigame:letters",
                title="Сыграть 3 буквенные игры",
                description="Закрепите знания букв",
                target=3,
                reward_coins=45,
                reward_xp=18,
            ),
            QuestStepDefinition(
                metric="minigame:letters",
                title="Сыграть 5 буквенных игр",
                description="Вы отлично освоили буквы",
                target=5,
                reward_coins=70,
                reward_xp=25,
            ),
